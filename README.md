...
It is designed to provide network developers an easy, efficient, and flexible way to create softwares which needs to send, receive and manipulate network packets.
